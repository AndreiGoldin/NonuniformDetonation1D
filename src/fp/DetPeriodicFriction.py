...
# These are functions that are used in the `Simulation` class. The decorators
# `@nb.njit` and `@nb.vecorize` tell `numba` that the decorated function should
# be compiled. For more details, see [Numba
# documentation](https://numba.pydata.org/numba-doc/latest/index.html) with
# excellent guides and examples.
